...
const variantStyles: Record<BadgeVariant, string> = {
  fruitveg: "bg-green-100 text-green-800 border-green-200",
  ...
  toiletries: "bg-pink-100 text-pink-800 border-pink-200",
  medicine: "bg-rose-100 text-rose-800 border-rose-200",
