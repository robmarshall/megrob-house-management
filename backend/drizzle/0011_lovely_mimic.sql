...
CREATE INDEX "idx_oauth_access_token_client_id" ON "oauth_access_token" USING btree ("client_id");--> statement-breakpoint
CREATE INDEX "idx_oauth_access_token_user_id" ON "oauth_access_token" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "idx_oauth_application_user_id" ON "oauth_application" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "idx_oauth_consent_client_id" ON "oauth_consent" USING btree ("client_id");--> statement-breakpoint
CREATE INDEX "idx_oauth_consent_user_id" ON "oauth_consent" USING btree ("user_id");